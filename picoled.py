...
def twinkle(np):
    ...
    for x in range(count):
        ...
        np[random.randint(0, num_pixels-1)] = (val, 0, 0)
...
pin_button = Pin(7, mode=Pin.IN, pull=Pin.PULL_UP)
...
# list of pointers to functions to iterate over
animations = [
        #bounce,
        cylon,
        neo_sweep,
...
try:
    #animations[0](pixels)
    #animations[4](pixels)
    n = len(animations) # number of animations
    #print (n)
